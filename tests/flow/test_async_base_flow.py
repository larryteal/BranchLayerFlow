from branchlayerflow import BaseMeta, AsyncBaseFlow
from types import AsyncGeneratorType
import pytest

@pytest.fixture
def flow():
    return AsyncBaseFlow(meta=BaseMeta(**{ "name": "async_base_flow" }), branches=())

def test_initial_value():
    flow = AsyncBaseFlow(meta=BaseMeta(**{ "name": "async_base_flow" }), branches=())
...
def test_rshift(flow):
    successor = AsyncBaseFlow(meta=BaseMeta(**{ "name": "successor_flow" }), branches=())
